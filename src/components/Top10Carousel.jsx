...
if(isFetching) return 'Loading...'
   ...
   return (
      <>
         ...
         <div className="flex -mt-10 whitespace-nowrap sm:space-x-5 sm:p-10 overflow-x-scroll  scrollbar-thin scrollbar-arrow-violet 
         scrollbar-thumb-custom  scroll-smooth scrollbar-track-transparent touch-pan-y ">
              
              {coins?.map((crypto) => (                
                <div className="last:pr-24"  key={crypto.id} >
                  <div className="item" >
